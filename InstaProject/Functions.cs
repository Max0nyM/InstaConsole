...
public  class Functions
    {
        const string API_KEY= "5ad7d6f013666cc93c88fc8af940348bd067b68f0dce3c85122a923f4f74b251";
         const string VERSION = "10.3.2";
      
        private static Random Random = new Random();

        public static string HMAC(string String)
        {
            var keyByte = Encoding.UTF8.GetBytes("5ad7d6f013666cc93c88fc8af940348bd067b68f0dce3c85122a923f4f74b251");
        ...
        public static string RandomUserAgentInsta()
        {
            ...
            Test.AppendFormat("Instagram "+VERSION+" Android (18/4.3; 320dpi; 720x1280; {0}; {1}; {2}; qcom; en_US)", one, two, three);
